...
public class addCourseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int courseCredit =Integer.parseInt(request.getParameter("course_credit"));
...
//            out.println(courseDescription);

            Course course = new Course(courseTitle, courseCode, courseCredit, courseType, courseDescription);
